...
//  DevoteWidget
//
//  Created by Igor Shulumba on 24.11.2024.
//
        ...
        GeometryReader { geomety in
            ZStack {
                ...
                Image("logo")
                    ...
                    .offset(x: (geomety.size.width / 2) - 20,
                    y: (geomety.size.height / -2) + 20)
                ...
                .padding()
                .offset(y: (geomety.size.width / 2 - 24))
            }
        }
//        VStack {
//            Text("Time:")
...
struct DevoteWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .description("This is an example widget for personal task manager.")
    }
}
