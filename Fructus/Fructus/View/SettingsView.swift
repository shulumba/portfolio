                    ...
                    GroupBox(label: 
                        ...
                        HStack(alignment: .center, spacing: 10) {
                            Image("logo")
                                ...
                                .cornerRadius(9)
                            Text("Most fruits are nuturally low in fat, sodium, and calories. None have cholesterol. Fruits are sources of many essential nutrients, including potassium dietary fuber, vitamins, and much more.")
                                .font(.footnote)
                        }
                    }
